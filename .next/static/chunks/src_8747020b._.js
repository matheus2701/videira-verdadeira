(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_8747020b._.js", {
...
function AuthProvider({ children }) {
    _s();
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(mockMissionario);
    ...
    const loginAs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[loginAs]": (role)=>{
            if (role === 'missionario') {
                setUser(mockMissionario);
            } else {
                const liderUser = usersData.find({
                    "AuthProvider.useCallback[loginAs]": (u)=>u.role === 'lider_de_celula' && u.vidaId === 'vida-lider-joao'
                }["AuthProvider.useCallback[loginAs]"]) || mockLiderUserInitial;
                setUser(liderUser);
            }
        }
    }["AuthProvider.useCallback[loginAs]"], [
        usersData
    ]);
                    ...
                    "AuthProvider.useCallback[updateMockVida]": (prevUsers)=>prevUsers.map({
                            "AuthProvider.useCallback[updateMockVida]": (u)=>{
                                if (u.vidaId === updatedVida.id && u.role === 'lider_de_celula') {
                                    ...
                                    if (user && user.id === u.id) {
                                        setUser({
                                            "AuthProvider.useCallback[updateMockVida]": (prevUser)=>prevUser ? {
                                                    ...prevUser,
                                                    cellGroupId: undefined,
                                                    cellGroupName: undefined
                                                } : null
    ...
    const toggleUserActiveStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[toggleUserActiveStatus]": (userId)=>{
            setUsersData({
...
_s(AuthProvider, "01V/qLmA6RX0+WJafQFcgVP1474=");
_c = AuthProvider;
var _c;
...
function AppShellInner({ children }) {
    _s();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { user, loginAs, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(AppShellInner, "3XUuvsUKCY5EGxkbVu8UGRLTSmQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
...
//# sourceMappingURL=src_8747020b._.js.map