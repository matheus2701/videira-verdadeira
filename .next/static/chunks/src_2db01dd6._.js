(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2db01dd6._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabaseClient.ts [app-client] (ecmascript)"); // Importar Supabase client
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AuthProvider({ children }) {
    ...
    const [loadingAuth, setLoadingAuth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Para saber quando o onAuthStateChange inicial concluiu
    ...
    const [usersData, setUsersData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialMockUsers); // Pode ser usado para exibir lista de usuários, etc.
            ...
            const { data: authListener } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthProvider.useEffect": async (event, session)=>{
                    ...
                    if (supabaseUser) {
                        ...
                        const matchingMockUser = initialMockUsers.find({
                            "AuthProvider.useEffect.matchingMockUser": (mu)=>mu.email.toLowerCase() === (supabaseUser.email || '').toLowerCase()
                        }["AuthProvider.useEffect.matchingMockUser"]);
                        if (matchingMockUser) {
                            appUser = {
                                ...appUser,
    ...
    }["AuthProvider.useEffect"], []); // Roda uma vez na montagem
    ...
    if (loadingAuth && "object" !== 'undefined' && !localStorage.getItem('authUser')) {
...
_s(AuthProvider, "YsSpt9fZ6Z+42WkoTrHFqRV0t0k=");
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=src_2db01dd6._.js.map